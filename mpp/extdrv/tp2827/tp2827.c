...
#endif
unsigned char tp2802_i2c_addr[] = {TP2802D_I2C_ADDR,
                                   TP2802C_I2C_ADDR
                                  };
...
//{
//#ifdef HI_I2C_DRV
//    hi_i2c_drv_write(1,tp2802_i2c_addr[chip], addr, 1, data, 1);
//    udelay(300); 
//#else
//    HI_I2C_Write1(tp2802_i2c_addr[chip], addr, 1, data, 1);
//    udelay(300);
//#endif   	
//}
...
//{	
//#ifdef HI_I2C_DRV
//    return (hi_i2c_drv_read(1,tp2802_i2c_addr[chip], addr, 1, 1) & 0xff);
//#else
//    return (HI_I2C_Read1(tp2802_i2c_addr[chip], addr, 1, 1) & 0xff);
//#endif
//}
...
static void tp282x_SYSCLK_V2(unsigned char chip, unsigned char ch)
{
    ...
    {
        if( TP2834 == id[chip] || id[chip] < TP2822 )
        {
...
#define SCSYSID_REG         IO_ADDRESS(0x12050EE8)
                    ...
                    if(SCAN_MANUAL != wdi->scan[i])
                    {
...

                        {
                            ...
                            if( TP2853C == id[iChip] || TP2826 == id[iChip] || TP2827 == id[iChip])// new 3M20/4M12 auto detect test
                            {
                                    ...
                                    {
                                        wdi-> mode[i] = TP2802_4MH30;
                                        tp2802_set_video_mode(iChip, wdi-> mode[i], i, STD_TVI);
                                    }
                                    if( (wdi->count[i] > 1) && (wdi-> mode[i] == TP2802_720P50))
                                    {
                                        wdi-> mode[i] = TP2802_4MH25;
                                        tp2802_set_video_mode(iChip, wdi-> mode[i], i, STD_TVI);
                                    }
