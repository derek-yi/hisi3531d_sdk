...
{    
    ...
    printf("NOTICE: Luma/Contrast/Hue/Satuature [0,100], enCscMatrix[0,2]\n");
...
HI_S32 vo_video_csc_config(HI_U32 u32LayerId, HI_U32 enCscMatrix, HI_U32 u32Luma, HI_U32 u32Contrast, HI_U32 u32Hue, HI_U32 u32Saturation)
{
    VO_CSC_S    stVideoCSC;
    //usage();
...
HI_S32 main(int argc, char *argv[])
{
    ...
    vo_video_csc_config(u32LayerId, enCscMatrix,u32Luma, u32Contrast, u32Hue, u32Saturation);
