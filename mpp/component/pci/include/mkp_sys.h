 ...
 ******************************************************************************
  ...
  Created       : 2007/1/31
  Description   : Hi35xx system private Head File
  History       :
  1.Date        : 2007/1/31
    Author      : c42025
...
#define SYS_DETECT_HEARTBEAT   _IO(IOC_TYPE_SYS, IOC_NR_SYS_DETECT_HEARTBEAT)
...
HI_VOID SYS_BIND_Clear(HI_VOID);
HI_S32  SYS_BIND_Exit(HI_VOID);
