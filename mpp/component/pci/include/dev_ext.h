...
#define UMAP_PCIV_MINOR_BASE  	26
#define UMAP_PCIVFMW_MINOR_BASE	27
#define UMAP_FD_MINOR_BASE   30
#define UMAP_DCCS_MINOR_BASE  31
#define UMAP_VEDU_MINOR_BASE  32
#define UMAP_ACODEC_MINOR_BASE 33
