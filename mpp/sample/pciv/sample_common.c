...
HI_S32 SAMPLE_StartVenc(HI_U32 u32GrpCnt, HI_BOOL bHaveMinor,PAYLOAD_TYPE_E aenType[2], PIC_SIZE_E aenSize[2],VIDEO_NORM_E enCodeMode) /**/	//l00346266 
{
    HI_S32 i;
    HI_S32 s32Ret;
    VENC_GRP VeGroup;
    ...
    for (i=0; i<u32GrpCnt; i++)
    {
		...
		s32Ret = SAMPLE_COMM_VENC_Start(VeChn,aenType[0],enCodeMode,aenSize[0],SAMPLE_RC_CBR,0);
		//s32Ret = SAMPLE_COMM_VENC_Start(VeChn,aenType[0],VIDEO_ENCODING_MODE_PAL,PIC_D1,SAMPLE_RC_CBR,0);
        if (s32Ret != HI_SUCCESS)
        {
            printf("\nSAMPLE_COMM_VENC_Start(%d,%d) err 0x%x\n", VeGroup, VeChn, s32Ret);
            return HI_FAILURE;
        }
		/*s32Ret = SAMPLE_COMM_VENC_StartGetStream(VeChn);
	    if (HI_SUCCESS != s32Ret)
	    {
...
{    
    ...
    switch (enIntfSync)
    {
        case VO_OUTPUT_PAL      :    u32Width = 720;  u32Height = 576;   u32FrmRt=25;	break;
        case VO_OUTPUT_NTSC     :    u32Width = 720;  u32Height = 480;   u32FrmRt=30;	break;
        case VO_OUTPUT_1080P24  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=24;	break;
        case VO_OUTPUT_1080P25  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=25;	break;
        case VO_OUTPUT_1080P30  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=30;	break;
        case VO_OUTPUT_720P50   :    u32Width = 1280; u32Height = 720;   u32FrmRt=50;	break;
        case VO_OUTPUT_720P60   :    u32Width = 1280; u32Height = 720;   u32FrmRt=60;	break;
        case VO_OUTPUT_1080I50  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=50;	break;
        case VO_OUTPUT_1080I60  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=60;	break;
        case VO_OUTPUT_1080P50  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=50;	break;
        case VO_OUTPUT_1080P60  :    u32Width = 1920; u32Height = 1080;  u32FrmRt=60;	break;
        case VO_OUTPUT_576P50   :    u32Width = 720;  u32Height = 576;   u32FrmRt=50;	break;
        case VO_OUTPUT_480P60   :    u32Width = 720;  u32Height = 480;   u32FrmRt=60;	break;
        case VO_OUTPUT_800x600_60:   u32Width = 800;  u32Height = 600;   u32FrmRt=60;	break;
        case VO_OUTPUT_1024x768_60:  u32Width = 1024; u32Height = 768;   u32FrmRt=60;	break;
        case VO_OUTPUT_1280x1024_60: u32Width = 1280; u32Height = 1024;  u32FrmRt=60;	break;
        case VO_OUTPUT_1366x768_60:  u32Width = 1366; u32Height = 768;   u32FrmRt=60;	break;
        case VO_OUTPUT_1440x900_60:  u32Width = 1440; u32Height = 900;   u32FrmRt=60;	break;
        case VO_OUTPUT_1280x800_60:  u32Width = 1280; u32Height = 800;   u32FrmRt=60;	break;
		case VO_OUTPUT_3840x2160_60:  u32Width = 3840; u32Height = 2160;   u32FrmRt=60;	break;
    ...
    if (NULL != pstLayerAttr)
    {
        ...
        pstLayerAttr->u32DispFrmRt          = u32FrmRt;
...
void VDEC_MST_DefaultH264HD_Attr(VDEC_CHN_ATTR_S *pstAttr)
{
	...
	pstAttr->stVdecVideoAttr.bTemporalMvpEnable = HI_FALSE;
}
