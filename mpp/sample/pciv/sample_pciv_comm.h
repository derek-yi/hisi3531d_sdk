...
#define IPC_VPSS_MAX_EXT_CHN_NUM 8
#define VPSS_CHN4				 4
#define VPSS_CHN5				 5
#define VPSS_CHN6				 6
#define VPSS_CHN7				 7
#define VPSS_CHN8				 8
#define VPSS_CHN9				 9
#define VPSS_CHN10				 10
#define VPSS_CHN11				 11

//#define SAMPLE_PCIV_PCIV_HD1080_VENC_STREAM_BUF_LEN 1920*1080*10
...
typedef struct hiSAMPLE_PCIV_MSG_INIT_VI_S
{
    ...
    //SAMPLE_VI_DEV_TYPE_E enViDevType;
...
typedef struct hiSAMPLE_PCIV_MSG_VPSS_S
{
    ...
    MPP_CHN_S stBInd;
    HI_BOOL  bBindVdec;
	HI_BOOL vpssChnStart[VPSS_MAX_CHN_NUM + IPC_VPSS_MAX_EXT_CHN_NUM];	
