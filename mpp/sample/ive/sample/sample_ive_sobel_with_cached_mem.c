	...
	HI_CHAR *pchSrcFileName,HI_U16 u16Width,HI_U16 u16Height)
{
	...
	sprintf(achFileName,"./data/output/sobel/sobelh1_720x576.yuv");
	...
	sprintf(achFileName,"./data/output/sobel/sobelh2_720x576.yuv");
	...
	sprintf(achFileName,"./data/output/sobel/sobelv1_720x576.yuv");
	...
	sprintf(achFileName,"./data/output/sobel/sobelv2_720x576.yuv");
...
HI_VOID SAMPLE_IVE_Sobel(HI_VOID)
{
	...
	HI_CHAR *pchSrcFileName = "./data/input/sobel/sobel_720x576.yuv";

    memset(&s_stSobel,0,sizeof(s_stSobel));
    SAMPLE_COMM_IVE_CheckIveMpiInit();
	
    s32Ret = SAMPLE_IVE_Sobel_Init(&s_stSobel,pchSrcFileName,u16Width,u16Height);
    if(HI_SUCCESS != s32Ret)
    {
    ...
    SAMPLE_IVE_SobelProc(&s_stSobel);
    
    SAMPLE_IVE_Sobel_Uninit(&s_stSobel);
    memset(&s_stSobel,0,sizeof(s_stSobel));

	SAMPLE_PRT("SAMPLE_IVE_Sobel finished!\n");
