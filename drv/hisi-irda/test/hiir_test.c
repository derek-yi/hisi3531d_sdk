...
void Test_Usage()
{   
    printf("please choose index, press 'q' to exit this sample.\n"); 
    printf("index:\n");
	printf("\t0:  Hi_IR_FUNC_TEST_001 \n");
    printf("\t1:  Hi_IR_FUNC_TEST_002 \n");
    printf("\t2:  Hi_IR_FUNC_TEST_003 \n");
    printf("\t3:  Hi_IR_FUNC_TEST_004 \n");
	printf("\t4:  Hi_IR_FUNC_TEST_005 \n");
    printf("\t5:  Hi_IR_FUNC_TEST_006 \n");
    printf("\t6:  Hi_IR_FUNC_TEST_007 \n");
    printf("\t7:  Hi_IR_FUNC_TEST_008 \n");
    printf("\t8:  Hi_IR_STRONG_TEST_001 \n");
    printf("\t9:  Hi_IR_STRONG_TEST_002 \n");
    printf("\ta:  Hi_IR_STRONG_TEST_003 \n");
	printf("\tq:  quit\n");
...
int  main(void)
{
    ...
    {   
        ...
        switch(ch)
        {
            case '0':{Hi_IR_FUNC_TEST_001();break;}
            case '1':{Hi_IR_FUNC_TEST_002();break;}
            case '2':{Hi_IR_FUNC_TEST_003();break;}
            case '3':{Hi_IR_FUNC_TEST_004();break;}
            case '4':{Hi_IR_FUNC_TEST_005();break;}
            case '5':{Hi_IR_FUNC_TEST_006();break;}
            case '6':{Hi_IR_FUNC_TEST_007();break;}
            case '7':{Hi_IR_FUNC_TEST_008();break;}
            case '8':{Hi_IR_STRONG_TEST_001();break;}
            case '9':{Hi_IR_STRONG_TEST_002();break;}
            case 'a':{Hi_IR_STRONG_TEST_003();break;}
            case 'q':{return 0;}
